                            ...
                            <table v-for="(order, index) in orderList" :key="order.OrderId" class="uk-table uk-table-small uk-text-small uk-margin-remove orderlist">
                                ...
                                <tbody>
                                    <tr class="uk-table-middle">
                                        ...
                                        <td class="border-top border-left" style="text-align: left; width: 150px;">{{ order.OrderDate }}<br><div class="uk-label uk-label-default">{{ order.ClickId }}</div><div class="uk-label" :class="{'uk-label-success':!order.SupplierName.includes('Hämta'),'uk-label-warning':order.SupplierName.includes('Hämta')}">{{ order.SupplierName }}</div></td>
